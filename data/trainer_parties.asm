...
GiovanniData:
; Rocket Hideout B4F
	db $FF,25,SANDSLASH,24,RHYHORN,24,KABUTO,29,KANGASKHAN,0
; Silph Co. 11F
	db $FF,37,NIDOKING,37,KANGASKHAN,37,RHYHORN,40,KABUTOPS,41,NIDOQUEEN,0
; Viridian Gym
	db $FF,46,KANGASKHAN,48,SANDSLASH,52,NIDOQUEEN,47,NIDOKING,46,RHYDON,50,KABUTOPS,0
RocketData:
; Mt. Moon B2F
...
BrunoData:
	db $FF,53,ONIX,55,HITMONCHAN,55,HITMONLEE,56,GOLEM,58,MACHAMP,57,POLIWRATH,0
BrockData:
...
SabrinaData:
	db $FF,37,MR_MIME,38,GARDEVOIR,38,GOLDUCK,38,JYNX,43,ALAKAZAM,0
GentlemanData:
; SS Anne 1F Rooms
...
Green3Data:
	db $FF,60,PIDGEOT,61,ALAKAZAM,61,RHYDON,61,ARCANINE,63,EXEGGUTOR,65,BLASTOISE,0
	db $FF,60,PIDGEOT,61,ALAKAZAM,61,RHYDON,61,GYARADOS,63,ARCANINE,65,VENUSAUR,0
	db $FF,60,PIDGEOT,61,ALAKAZAM,61,RHYDON,61,EXEGGUTOR,63,GYARADOS,65,CHARIZARD,0
LoreleiData:
	db $FF,54,DEWGONG,54,CLOYSTER,55,SLOWBRO,56,JYNX,56,LAPRAS,56,OMASTAR,0
ChannelerData:
; Pokémon Tower 3F
	db 23,GASTLY,0
	db 24,GASTLY,0
...
; Unused
	...
	;db 24,GASTLY,0
AgathaData:
	db $FF,55,GENGAR,56,TENTACRUEL,56,GOLBAT,58,ARBOK,60,GENGAR,58,WEEZING,0
LanceData:
	db $FF,58,GYARADOS,56,DRAGONITE,62,DRAGONITE,60,AERODACTYL,60,SALAMENCE,58,SEADRA,0
RosterLabelEnd::
